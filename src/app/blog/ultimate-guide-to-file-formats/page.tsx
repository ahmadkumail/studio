  ...
  return (
    <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      <article className="prose prose-lg mx-auto text-foreground">
        ...
        <p>
          These formats store visual data. The key trade-off is between file size and quality, driven by their compression method. For a deeper analysis, see our <Link href="/blog/jpg-vs-png-which-format-to-use" className="text-primary hover:underline">JPG vs. PNG guide</Link>.
        </p>
